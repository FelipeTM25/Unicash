...
import { AjustesMenuItem } from '../components/Items/AjustesMenuItem'
    ...
    return (
        <>
            ...
            <MobileScreen>
                ...
                <h1 className="mt-4 text-center text-3xl leading-tight font-bold text-title sm:text-4xl md:text-5xl">
                    Ajustes
                </h1>
