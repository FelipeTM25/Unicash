...
export function FormField({ label, hideLabel = false, placeholder, prefix, type = 'text', inputMode, value, onValueChange }: FormFieldProps) {
    const inputId = useId()
    ...
    return (
        <label htmlFor={inputId} className="flex w-full flex-col gap-3">
            ...
            <div className="flex h-12 w-full items-center gap-3 rounded-2xl border-2 border-border px-4 transition-colors duration-200 hover:border-label focus-within:border-title focus-within:ring-2 focus-within:ring-title/20 sm:h-14 sm:px-5 md:h-15">
